...
export default function CadastroCliente(){
    ...
    const [editaCliente, setEditaCliente] = useState(false);
    ...
    const handleEditaCliente = () => {
        setEditaCliente(true);   
    }
    //===========================================================================================
    ...
    //               }  
    //              // document.getElementById("lista").innerHTML = string_final;
    //             })
    //             .catch((error) => console.log(error));            
    //     }
    // }, [carregaCliente]);
    ...
    return(
        <>
            ...
            <Form style={({ margin: "5px" }, { marginLeft: "80px" })}>
                ...
                <br/>
                <button style={({ margin: "5px" }, { marginLeft: "80px" })} onClick={handleInsereCliente}>Cadastrar</button>
                <br/>
                <br/>
                <button style={({ margin: "5px" }, { marginLeft: "80px" })} onClick={handleCarregaCliente}>Carregar</button>
                <br/>
                <br/>
                <button style={({ margin: "5px" }, { marginLeft: "80px" })} onClick={handleDeletaCliente}>Deletar</button>
                <br/>
                <br/>
                <button style={({ margin: "5px" }, { marginLeft: "80px" })} onClick={handleEditaCliente}>Editar</button>
                <h5></h5>
